...
import { getPinballDemoState } from '../../demo/sceneBots.js';
...
export class PinballScene extends BaseGameScene {
  ...
  update(time, delta) {
    ...
    const demoFlips = DemoDirector.enabled ? getPinballDemoState(this, time) : { left: false, right: false, plunge: false };
